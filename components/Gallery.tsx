...
const GALLERY_ITEMS = [
  {
    src: 'https://images.unsplash.com/photo-1601362840469-51e4d8d58785?w=800&q=75',
  ...
  },
  {
    ...
    alt: 'Custom auto paint finish — black sports car',
    tag: 'Paint Work',
    span: '',
  },
  {
    src: 'https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=600&q=75',
    alt: 'Sports car restoration project at our Manassas shop',
    tag: 'Restoration',
    span: '',
  },
  {
    src: 'https://images.unsplash.com/photo-1615906655593-ad0386982a0f?w=600&q=75',
    alt: 'Auto body dent repair and panel work',
    tag: 'Body Work',
    span: '',
  },
  {
    src: 'https://images.unsplash.com/photo-1558979158-65a1eaa08691?w=600&q=75',
    alt: 'Wheel and tire service at Automotive 24/7',
    tag: 'Wheels & Tires',
    span: '',
  },
  {
    src: 'https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?w=800&q=75',
