...
const GALLERY_ITEMS = [
  ...
  },
  {
    ...
    alt: 'Custom paint finish — professional auto paint work at Automotive 24/7',
    category: 'Paint Work',
    size: 'normal',
  },
  {
    src: '/gallery/restoration.jpg',
    alt: 'Full vehicle restoration project at Automotive 24/7 Manassas VA',
  ...
  {
    src: '/gallery/brakes-and-suspension.jpg',
    alt: 'Suspension component inspection and service',
    category: 'Suspension',
    size: 'tall',
  },
  {
    src: '/gallery/brakes-and-suspension.jpg',
    alt: 'Brake service and rotor replacement at Automotive 24/7',
    category: 'Brakes',
    size: 'normal',
  },
  {
